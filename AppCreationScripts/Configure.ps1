...
#> 
   ...
   Write-Host "Creating the AAD application (TodoListService-Headless)"
   ...
   Write-Host "Done creating the service application (TodoListService-Headless)"
   ...
   Write-Host "Creating the AAD application (TodoListClient-Headless)"
   ...
   Write-Host "Done creating the client application (TodoListClient-Headless)"
